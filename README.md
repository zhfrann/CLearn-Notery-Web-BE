...
> You have to do this if only there is no image for dummy data in ./storage/app/public, because it's contain profiles, notes, and default thumbnail images for dummy data
